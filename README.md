...
The repository is already delivered with the generated analytical outputs and evidence.

For a fresh reproducible run:
...
Then run the scripts in numerical order from the `python/` folder.

The pipeline regenerates the raw data, cleans it, loads SQLite, executes the business questions, calculates KPIs and prepares the Power BI data.

## Validation

The final build was checked for:

- exactly 200,000 encounter records
...
- README image paths
- removal of temporary working data from the GitHub package

## Limitations

- The data is synthetic.
- The project does not contain real patient records.
- Results are for analytics/research demonstration.
- The analysis is operational and should not be used for clinical decision-making.
- A live `.pbix` could not be compiled because Power BI Desktop was unavailable in the Linux build environment.

## Future Improvements

- connect to a real hospital data warehouse
- add demand forecasting
- add real-time operational monitoring
- add predictive readmission analysis
- add staffing and capacity optimization

## Disclaimer

This project uses synthetic healthcare data created for educational, research and analytics demonstration purposes. It does not contain real patient information and should not be used for clinical decision-making.
